...
VALUES
  (
    ...
    'A dead human awakens as a helpless ant larva in Eldara, an insect world moving toward war, tournament, and the mystery of a vanished Ant King.',
    '0.3.0',
...
VALUES (
  ...
  JSON_OBJECT(
    ...
    'privateTruths', JSON_ARRAY('Royal Soul Resonance connects the player to the vanished Ant King', 'The Grand Insect Tournament gathers soul energy', 'The Great War is tied to ancient manipulation', 'The sanctuary truth belongs to Chapter 12', 'Final evolution is resolved from the whole run'),
