...
function localGameMaster(context) {
  ...
  const narration = [
    ...
    sensory,
    "The colony does not pause for your confusion. Bodies press close in the damp dark, each larva a warm weight against you, each worker a moving wall of chitin and purpose. Their world is not built from words. It is built from pressure, hunger, direction, alarm, and obedience, all of it flowing through the air in signals your human mind keeps trying to translate too cleanly.",
    ...
    "You do not know whether she sees intelligence, sickness, danger, or simply a larva behaving in a way no larva should. Her mandibles hover close enough for you to understand how easily this new life could end. Yet she does not crush you. She adjusts your position among the brood with almost careful precision, as if protecting the colony now requires keeping you alive long enough to understand what you are.",
    "The action leaves a mark in you, small but real. Not power. Not answers. A shape of attention. Your human fear and your ant instincts do not fit together, but for the first time they both point in the same direction: notice everything, survive this moment, remember what the colony ignores.",
