...
const fallbackFlow = {
  ...
  phases: [
    ...
    { phase: 5, title: 'Exploration', summary: 'The story moves through 5 Dungeons with 3 Floors each; every third Floor is a boss.' },
    ...
    { phase: 8, title: 'The End of the Cycle', summary: 'Completing all 5 Dungeons makes that character part of history.' },
